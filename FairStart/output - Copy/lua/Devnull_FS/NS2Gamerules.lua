    ...
    function NS2Gamerules:SetGameState(state)
        if state ~= self.gameState then
            ...
            elseif self.gameState == kGameState.Countdown then
                ...
                print("Marine: " .. tostring(MarineLocation))
                print("MarineX: " .. tostring(MarineLocation.x))
                print("MarineZ: " .. tostring(MarineLocation.z))
                --MarineTeam:SetFairStartPing(AlienLocation)
                --AlienTeam:SetFairStartPing(MarineLocation)
