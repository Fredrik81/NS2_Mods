...
function PlayingTeam:Initialize(teamName, teamNumber)
    ...
    self.FairStartPingPosition = Vector(0,0,0)
...
function PlayingTeam:GetFairStartPingPosition()
    return self.FairStartPingPosition
end
...
function PlayingTeam:SetFairStartPing(position)
    self.FairStartPingPosition = position
    print("Setting self.lastFairStartPingPosition: " .. tostring(position))
end
