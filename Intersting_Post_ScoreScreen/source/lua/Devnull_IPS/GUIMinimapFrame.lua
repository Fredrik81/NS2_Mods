...
function GUIMinimapFrame:SetBackgroundMode(setMode, forceReset)
    ...
    if (setMode == 0 and self.comMode == 1) or (setMode == 2 and self.comMode == 0) then
        MapCheckStartStopTimer(2, 'Frame setmode ' .. tostring(setMode) .. ' comMode: ' .. tostring(self.comMode))
    end
