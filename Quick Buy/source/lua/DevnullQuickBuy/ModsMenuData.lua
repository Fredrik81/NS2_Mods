...
local menu = {
    ...
    contentsConfig = ModsMenuUtils.CreateBasicModsMenuContents {
        ...
        contents = { -----General
        {
            ...
            properties = {{"Label", "Enable quickbuy functionality"}}
        }, {
            name = "dqb_showlabels",
            class = OP_TT_Checkbox,
            params = {
            ...
            properties = {{"Label", "Show Quick Buy Labels"}}
        }, {
            name = "dqb_closeonbuy",
            class = OP_TT_Checkbox,
            params = {
            ...
            properties = {{"Label", "Close menu on marine purchase"}}
        }, -----Aliens
        {
        ...
        }, -----Abilities Shells
        {
            ...
            properties = {{"Label", "Select Regeneration"}}
        }, {
            name = "dqb_carapace",
            class = OP_Keybind,
            params = {
            ...
            properties = {{"Label", "Select Carapace"}}
        }, {
            name = "dqb_vampirism",
            class = OP_Keybind,
            params = {
            ...
            properties = {{"Label", "Select Vampirism"}}
        }, -----Abilities Spurs
        {
            name = "dqb_adrenaline",
            class = OP_Keybind,
            ...
            properties = {{"Label", "Select Adrenaline"}}
        }, {
            name = "dqb_celerity",
            class = OP_Keybind,
            params = {
            ...
            properties = {{"Label", "Select Celerity"}}
        }, {
            name = "dqb_crush",
            class = OP_Keybind,
            params = {
        ...
        }, -----Abilities Veils
        {
            ...
            properties = {{"Label", "Select Camouflage"}}
        }, {
            name = "dqb_focus",
            class = OP_Keybind,
            params = {
        ...
        -----Armory
        {
            ...
            properties = {{"Label", "Purchase Welder"}}
        }, {
            name = "dqb_mines",
            class = OP_Keybind,
            params = {
            ...
            properties = {{"Label", "Purchase Mines"}}
        }, {
            name = "dqb_shotgun",
            class = OP_Keybind,
            params = {
            ...
            properties = {{"Label", "Purchase Shotgun"}}
        }, {
            name = "dqb_cluster",
            class = OP_Keybind,
            params = {
            ...
            properties = {{"Label", "Purchase Cluster Grenades"}}
        }, {
            name = "dqb_nervegas",
            class = OP_Keybind,
            params = {
            ...
            properties = {{"Label", "Purchase Nerve Gas"}}
        }, {
            name = "dqb_pulse",
            class = OP_Keybind,
            params = {
            ...
            properties = {{"Label", "Purchase Pulse Grenades"}}
        }, {
            name = "dqb_gl",
            class = OP_Keybind,
            params = {
            ...
            properties = {{"Label", "Purchase Grenade Launcher"}}
        }, {
            ...
            properties = {{"Label", "Purchase Flamethrower"}}
        }, {
            name = "dqb_hmg",
            class = OP_Keybind,
            params = {
        ...
        }, -----Prototype Lab
        {
            ...
            properties = {{"Label", "Purchase Jetpack"}}
        }, {
            name = "dqb_exomini",
            class = OP_Keybind,
            params = {
            ...
            properties = {{"Label", "Purchase Minigun Exo"}}
        }, {
            name = "dqb_exorail",
            class = OP_Keybind,
            params = {
            ...
            properties = {{"Label", "Purchase Railgun Exo"}}
        }}
    }
}
