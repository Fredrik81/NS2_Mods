...
local kPlayerCommIconsTexture = PrecacheAsset("ui/Scorescreen/ComSkillBadges.dds")
...
local kEalAlienTexture = PrecacheAsset("ui/Scorescreen/Alien.dds")
local kEalMarineTexture = PrecacheAsset("ui/Scorescreen/Marine.dds")
local EALitems = {}
    ...
    for index, team in ipairs(self.teams) do
        ...
        if vis then
            ...
            if numPlayers > 0 then
                if teamGUISize[team.TeamNumber] == nil then -- ToDo: Check if we need to change to playerRecord
