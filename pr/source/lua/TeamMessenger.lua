...
kTeamMessages[kTeamMessageTypes.GameStarted] = { text = { [kMarineTeamType] = function(data) return locationStringGen(data, "MARINE_TEAM_GAME_STARTED") end, [kAlienTeamType] = function(data) return locationStringGen(data, "ALIEN_TEAM_GAME_STARTED") end } }
